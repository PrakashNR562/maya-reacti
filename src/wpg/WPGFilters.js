...
const WPGFilters = function ({ categoryAttached }) {
  const {
  ...
  const categories = getUniqueValues(all_wpg, "category");

  const companies = getUniqueValues(all_wpg, "company");
