...
const ElectricalsFilters = function ({ categoryAttached }) {
  const {
  ...
  const categories = getUniqueValues(all_electricals, "category");

  const companies = getUniqueValues(all_electricals, "company");
...
export default ElectricalsFilters;
